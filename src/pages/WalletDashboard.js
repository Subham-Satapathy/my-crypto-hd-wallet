...
function WalletDashboard() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-gradient-to-r from-blue-900 via-purple-900 to-pink-900 text-white">
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg max-w-md w-full">
        ...
        <pre className="bg-gray-700 p-4 rounded-lg overflow-x-auto">{publicKey}</pre>
      </div>
    </div>
  );
}
